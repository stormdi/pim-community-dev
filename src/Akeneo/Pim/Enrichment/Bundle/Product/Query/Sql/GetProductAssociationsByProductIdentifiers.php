...
final class GetProductAssociationsByProductIdentifiers
{
    ...
    public function fetchByProductIdentifiers(array $productIdentifiers): array
    {
        ...
        $productIdentifiers = (function (string ...$identifier) {
            return $identifier;
        })(... $productIdentifiers);
...
FROM (
         ...
         FROM (
                  -- CROSS JOIN TO BUILD ALL ASSOCIATIONS BETWEEN PRODUCT AND TYPES NOT NECESSARY FOR THE OTHER ONES 
                  SELECT
